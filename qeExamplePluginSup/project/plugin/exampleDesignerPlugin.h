...
#ifndef EXAMPLEDESIGNERPLUGIN_H
#define EXAMPLEDESIGNERPLUGIN_H
...
class exampleWidgets: public QObject, public QDesignerCustomWidgetCollectionInterface {
    ...
    Q_PLUGIN_METADATA(IID "au.org.synchrotron.example" FILE "qeplugin.json")
#endif
