/* $File: //ASP/tec/gui/qevcl/trunk/qeVCLApp/src/project/widgets/dblslits/vcl_dblslits_manager.h $
 * $Revision: #1 $
 * $DateTime: 2020/09/08 22:09:42 $
...
#ifndef VCL_DOUBLE_SLITS_MANAGER_H
#define VCL_DOUBLE_SLITS_MANAGER_H

#include <QEDesignerPluginCommon.h>
#include <visual_component_library_global.h>

class VISUAL_COMPONENT_LIBRARY_SHARED VCLDoubleSlitsManager :
   public QObject,
   public QDesignerCustomWidgetInterface
{
   ...
   QE_DECLARE_PLUGIN_MANAGER (VCLDoubleSlits)
};

#endif // VCL_DOUBLE_SLITS_MANAGER_H
