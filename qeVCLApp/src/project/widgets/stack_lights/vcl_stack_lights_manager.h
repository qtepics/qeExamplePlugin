...
#ifndef VCL_STACK_LIGHTS_MANAGER_H
#define VCL_STACK_LIGHTS_MANAGER_H

#include <QEDesignerPluginCommon.h>
#include <visual_component_library_global.h>

class VISUAL_COMPONENT_LIBRARY_SHARED VCLStackLightsManager :
   public QObject,
   public QDesignerCustomWidgetInterface
{
   ...
   QE_DECLARE_PLUGIN_MANAGER (VCLStackLights)
};

#endif // VCL_STACK_LIGHTS_MANAGER_H
