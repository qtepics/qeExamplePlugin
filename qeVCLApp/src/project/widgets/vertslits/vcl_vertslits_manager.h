/* $File: //ASP/tec/gui/qevcl/trunk/qeVCLApp/src/project/widgets/vertslits/vcl_vertslits_manager.h $
 * $Revision: #1 $
...
#ifndef VCL_VERTICAL_SLITS_MANAGER_H
#define VCL_VERTICAL_SLITS_MANAGER_H

#include <QEDesignerPluginCommon.h>
#include <visual_component_library_global.h>

class VISUAL_COMPONENT_LIBRARY_SHARED VCLVerticalSlitsManager :
   public QObject,
   public QDesignerCustomWidgetInterface
{
   ...
   QE_DECLARE_PLUGIN_MANAGER (VCLVerticalSlits)
};

#endif // VCL_VERTICAL_SLITS_MANAGER_H
