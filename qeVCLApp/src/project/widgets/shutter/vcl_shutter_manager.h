/* $File: //ASP/tec/gui/qevcl/trunk/qeVCLApp/src/project/widgets/shutter/vcl_shutter_manager.h $
 * $Revision: #1 $
...
#ifndef VCL_SHUTTER_MANAGER_H
#define VCL_SHUTTER_MANAGER_H

#include <QEDesignerPluginCommon.h>
#include <visual_component_library_global.h>

class VISUAL_COMPONENT_LIBRARY_SHARED VCLShutterManager :
   public QObject,
   public QDesignerCustomWidgetInterface
{
   ...
   QE_DECLARE_PLUGIN_MANAGER (VCLShutter)
};

#endif // VCL_SHUTTER_MANAGER_H
