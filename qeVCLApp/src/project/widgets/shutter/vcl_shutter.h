/* $File: //ASP/tec/gui/qevcl/trunk/qeVCLApp/src/project/widgets/shutter/vcl_shutter.h $
 * $Revision: #5 $
 * $DateTime: 2021/07/27 17:47:47 $
...
#ifndef VCL_SHUTTER_H
#define VCL_SHUTTER_H
...
namespace Ui {
    class VCLShutter;  // differed
}

// VCLShutter and VCLValve are essentially identical, apart from
// the icons used for each state - keep in sync.
//
class VISUAL_COMPONENT_LIBRARY_SHARED VCLShutter :
...
public:
   explicit VCLShutter (QWidget* parent = 0);
   ~VCLShutter ();
