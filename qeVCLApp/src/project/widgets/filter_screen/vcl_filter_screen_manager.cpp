/* File: qeVCLApp/src/project/widgets/filter_screen/vcl_filter_screen_manager.cpp
...
QE_IMPLEMENT_PLUGIN_MANAGER
   (VCLFilterScreen, "AS VCL", ":/vcl/filter_screen/vcl_filter_screen_r00_withdrawn.png", false)
